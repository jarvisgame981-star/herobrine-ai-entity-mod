...
public class HerobrineDisguiseSheepEntity extends Sheep {
	private final HerobrineDisguiseController disguiseController = new HerobrineDisguiseController(this);

	public HerobrineDisguiseSheepEntity(EntityType<? extends HerobrineDisguiseSheepEntity> entityType, Level level) {
	...
	@Override
	public void shear(ServerLevel serverLevel, net.minecraft.sounds.SoundSource soundSource, ItemStack stack) {
	}
